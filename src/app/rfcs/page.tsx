...
export default async function Home() {
    ...
    const rfcs = await listRFCs((session as unknown as { accessToken: string }).accessToken)
                        ...
                        <div className="flex items-start justify-between gap-6">
                            <div className="flex-1">
                                <div className="mb-2 flex items-baseline gap-3">
                                    <h2 className="text-xl font-bold tracking-tight text-black">{rfc.title}</h2>
                                    <span
                                ...
                                <div className="flex items-center gap-4 text-xs font-medium tracking-wide text-gray-70">
                                    <div className="flex items-center gap-2">
                                        <div className="h-5 w-5 border-2 border-black">
                                            <img src={rfc.authorAvatar} alt={rfc.author} className="h-full w-full" />
                                        </div>
