...
interface RFCDetailLoadingSkeletonProps {
  ...
  /** Staggered entry for route `loading.tsx` only; omit on client for seamless handoff. */
  entry?: boolean;
}

const SHELL_CLASS = "mx-auto min-h-screen max-w-360 px-4 sm:px-8 py-6 sm:py-12";
